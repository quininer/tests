...
function keyup2( force )
{
    var t = document.getElementById( "src2" ).value;
    var v = document.getElementById( "var2" ).value || "$";
	var p = document.getElementById( "palindrome2" ).checked;
	var r;
    ...
    if( _prev != ( t + "\0" + v + "\0" + p ) || force ){
		...
		document.getElementById("dst2").value = r;
		document.getElementById("letters").innerHTML = r.length;
        _prev = t + "\0" + v;
        document.getElementById( "permalink2").setAttribute( "href", 
...
function init2()
{
    ...
    for( var i = 0; i < q.length; i++ ){
        if( q[ i ].substring( 0, 4 ) == "src=" ){
            document.getElementById( "src2" ).value = decodeURIComponent( q[ i ].substring( 4 ) );
        }else if( q[ i ].substring( 0, 4 ) == "var=" ){
            document.getElementById( "var2" ).value = decodeURIComponent( q[ i ].substring( 4 ) );
        }else if( q[ i ].substring( 0, 2 ) == "p=" ){
            document.getElementById( "palindrome2" ).checked = q[ i ].substring( 2 ).valueOf() == 1;
        }
