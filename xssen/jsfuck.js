...
(function(self){
  ...
  function encode2(input, wrapWithEval){
    var output = [];
        ...
        if (replacement){
          ...
          if (c === "J") {
            replacement =
              "([][" + encode2("filter") + "]" +
              "[" + encode2("constructor") + "]" +
              "(" + encode2("return new Date(200000000)") + ")()+[])[!+[]+!+[]+!+[]+!+[]]";
            ...
            replacement =
              "([][" + encode2("filter") + "]" +
              "[" + encode2("constructor") + "]" +
              "(" + encode2("return new Date(24000000000)") + ")()+[])[!+[]+!+[]+!+[]+!+[]]";
            ...
            replacement =
              "([]+[])[" + encode2("constructor") + "]" +
              "[" + encode2("fromCharCode") + "]" +
              "(" + encode2(c.charCodeAt(0) + "") + ")";
